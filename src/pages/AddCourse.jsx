    ...
    <div className="flex min-h-[calc(100vh-4rem)] flex-col">
      ...
      <div className="sticky top-0 z-10 flex shrink-0 items-center justify-between gap-4 border-b border-border bg-background px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground">{t('courses.addNewCourse')}</h1>
            <p className="text-xs text-muted-foreground">{t('courses.addNewCourseSubtitle')}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button type="submit" form="add-course-form" variant="default" disabled={loading} className="gap-2">
            <FiSave className="size-4" aria-hidden />
            {loading ? t('common.saving') : t('courses.createCourse')}
          </Button>
        </div>
      </div>
